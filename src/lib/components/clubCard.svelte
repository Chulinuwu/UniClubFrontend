...
<div class="{className} max-w-[400px] h-[100px] p-2 w-full rounded-md bg-uni-graybox flex gap-3">
	<Profile
		{imageURL}
		class="bg-white min-w-[80px] min-h-[80px] w-auto h-auto rounded p-2 shadow-md"
	/>
